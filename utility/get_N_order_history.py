'''
get_N_users.py
This script is used to get N the order history of N users in the system.
'''
...
parser = argparse.ArgumentParser(description="Send N GET requests to URL/user/purchased/<id> at " +
...
def get_n_users(process_id, url):
    ...
    for _i in range(start_id, n):
        ...
        # Send GET request to get user purchase history
